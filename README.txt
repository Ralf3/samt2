...
gx.set_all_nd(val):      # mat[i,j]=val if m[i,j]!=nodata
...
gx.mixin(nr=30)        # get an array containing the mixin of a grid
gx.complexity(nr=30)   # uses the mixin to calculate a complexity number
