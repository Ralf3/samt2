...
class MyHelp(QtGui.QMainWindow, Ui_helpwin):
	...
	# toolbar icons
	self.ui.actionHome.setIcon(QIcon(env1+'/normal_actions.png'))
	self.ui.actionSpacer.setIcon(QIcon(env1+'/spacer.png'))
	self.ui.actionBack.setIcon(QIcon(env1+'/back.png'))
	self.ui.actionForward.setIcon(QIcon(env1+'/forward.png'))
	...
	hpath = env +'/html/manual.html'
	self.ui.textBrowser.setSource(QUrl(hpath))     
