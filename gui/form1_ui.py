...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(866, 664))
        icon = QtGui.QIcon()
        ...
        self.centralwidget.setMinimumSize(QtCore.QSize(870, 577))
        ...
        self.treeWidget.setMinimumSize(QtCore.QSize(200, 565))
        ...
        self.menuMake_Map = QtGui.QMenu(self.menuAnalysis)
        self.menuMake_Map.setObjectName(_fromUtf8("menuMake_Map"))
        ...
        self.actionUTM31 = QtGui.QAction(MainWindow)
        self.actionUTM31.setObjectName(_fromUtf8("actionUTM31"))
        self.actionUTM32 = QtGui.QAction(MainWindow)
        self.actionUTM32.setObjectName(_fromUtf8("actionUTM32"))
        self.actionUTM33 = QtGui.QAction(MainWindow)
        self.actionUTM33.setObjectName(_fromUtf8("actionUTM33"))
        self.actionUTM_31 = QtGui.QAction(MainWindow)
        self.actionUTM_31.setObjectName(_fromUtf8("actionUTM_31"))
        self.actionUTM_32 = QtGui.QAction(MainWindow)
        self.actionUTM_32.setObjectName(_fromUtf8("actionUTM_32"))
        self.actionUTM_33 = QtGui.QAction(MainWindow)
        self.actionUTM_33.setObjectName(_fromUtf8("actionUTM_33"))
        self.actionERTS89_1 = QtGui.QAction(MainWindow)
        self.actionERTS89_1.setObjectName(_fromUtf8("actionERTS89_1"))
        self.actionERTS89_2 = QtGui.QAction(MainWindow)
        self.actionERTS89_2.setObjectName(_fromUtf8("actionERTS89_2"))
        self.actionERTS89_3 = QtGui.QAction(MainWindow)
        self.actionERTS89_3.setObjectName(_fromUtf8("actionERTS89_3"))
        self.actionWGS_84 = QtGui.QAction(MainWindow)
        self.actionWGS_84.setObjectName(_fromUtf8("actionWGS_84"))
        self.actionGK_5 = QtGui.QAction(MainWindow)
        self.actionGK_5.setObjectName(_fromUtf8("actionGK_5"))
        self.actionEPSG = QtGui.QAction(MainWindow)
        self.actionEPSG.setObjectName(_fromUtf8("actionEPSG"))
        self.actionSample_p = QtGui.QAction(MainWindow)
        self.actionSample_p.setObjectName(_fromUtf8("actionSample_p"))
        self.actionShow_p1 = QtGui.QAction(MainWindow)
        self.actionShow_p1.setObjectName(_fromUtf8("actionShow_p1"))
        self.actionShow_p = QtGui.QAction(MainWindow)
        self.actionShow_p.setObjectName(_fromUtf8("actionShow_p"))
        ...
        self.menuMake_Map.addAction(self.actionGK_5)
        self.menuMake_Map.addAction(self.actionUTM_31)
        self.menuMake_Map.addAction(self.actionUTM_32)
        self.menuMake_Map.addAction(self.actionUTM_33)
        self.menuMake_Map.addAction(self.actionERTS89_1)
        self.menuMake_Map.addAction(self.actionERTS89_2)
        self.menuMake_Map.addAction(self.actionERTS89_3)
        ...
        self.menuAnalysis.addSeparator()
        self.menuAnalysis.addAction(self.menuMake_Map.menuAction())
        ...
        self.menuAnalysis.addAction(self.actionSample_p)
        ...
        self.menuPoints.addAction(self.actionShow_p)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuMake_Map.setTitle(_translate("MainWindow", "Make_Map", None))
        ...
        self.actionUTM31.setText(_translate("MainWindow", "UTM31", None))
        self.actionUTM32.setText(_translate("MainWindow", "UTM32", None))
        self.actionUTM33.setText(_translate("MainWindow", "UTM33", None))
        self.actionUTM_31.setText(_translate("MainWindow", "UTM 31", None))
        self.actionUTM_32.setText(_translate("MainWindow", "UTM 32", None))
        self.actionUTM_33.setText(_translate("MainWindow", "UTM 33", None))
        self.actionERTS89_1.setText(_translate("MainWindow", "ERTS89 1", None))
        self.actionERTS89_2.setText(_translate("MainWindow", "ERTS89 2", None))
        self.actionERTS89_3.setText(_translate("MainWindow", "ERTS89 3", None))
        self.actionWGS_84.setText(_translate("MainWindow", "WGS 84", None))
        self.actionGK_5.setText(_translate("MainWindow", "GK 5", None))
        self.actionEPSG.setText(_translate("MainWindow", "EPSG", None))
        self.actionSample_p.setText(_translate("MainWindow", "Sample_p", None))
        self.actionSample_p.setStatusTip(_translate("MainWindow", "Sample_p:  samples P1=n random points from the highlighted grid, all points for mat[i,j] > P2 ", None))
        self.actionShow_p1.setText(_translate("MainWindow", "Show_p1", None))
        self.actionShow_p1.setStatusTip(_translate("MainWindow", "Show_p: P1=grid, P2=color (r, g, b, k, w) , P3=point size (px),  highlighted=points", None))
        self.actionShow_p.setText(_translate("MainWindow", "Show_p", None))
        self.actionShow_p.setStatusTip(_translate("MainWindow", "Show_p: adds points to an image, P1=grid, P2=color (r, g, b, k, w) , P3=point size (px),  highlighted=points", None))
